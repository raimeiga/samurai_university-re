    ...
    <!-- メインビジュアル -->
    <!-- get_header関数＝ヘッダーを呼び出している  header.php内の<?php wp_head(); ?>と呼応-->
    <?php get_header();?>  
    <div class="home">
                   ...
                   <div class="col-lg-3 col-md-4 col-sx-12">
                     <div class="calendar_border">
                       <div class="calendar_border_1">           
                         <!-- post_custom()＝カスタムフィールドの値を取得する関数 -->                       
                         <div class="calendar_month">                              
                              <?php echo post_custom('month'); ?>   <!-- イベント開催日の表示　開催する月 -->
                         </div>                         
                         <div class="calendar_day">
                            <span>
                              <?php echo post_custom('day'); ?>  <!-- イベント開催日の表示　開催日 -->
                            </span>
                         </div>
                       </div>
                     </div>
    ...
    <!-- 数字ここまで -->
    <!-- get_footer関数＝フッダーを呼び出している  footer.php内の<?php wp_footer(); ?>と呼応-->
    <?php get_footer(); ?>
